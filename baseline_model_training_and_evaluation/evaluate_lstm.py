...
model_paths = {
    ...
    # "MuRIL_30_epochs": "trained_models/muril_epoch_30.pth",
...
for model_name, model_path in model_paths.items():
    ...
    model = EmojifierLSTM(input_dim, hidden_dim, output_dim).to(device)
...
output_file = "evaluation_metrics_lstm.json"
import json
